            ...
            <div className="mt-auto pt-6 border-t border-gray-50">
               <div className="mb-6 flex items-center gap-3 rounded-2xl bg-gray-50 p-3">
                  ...
                  <div className="flex-1 overflow-hidden">
                    <p className="truncate text-xs font-black text-gray-900">{user?.full_name || "Sinh Viên"}</p>
                    <p className="truncate text-[10px] font-medium text-gray-500">{user?.email || "student@vlute.edu.vn"}</p>
                  </div>
               </div>
              <button 
